...
<body>
    ...
    <form  action="../auditor/scrud.php">
    <a href="../auditor/scrud.php?iduser=<?php echo $idu?> & nombaux=<?php echo $nombre?>" target="_blank">
		<input class="btn" type="button" name="fact" value="Facturas"></a>
